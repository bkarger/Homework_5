...
Conversion of df to sf object of homicides.  
...
ggplot() +
  ...
  ggtitle("Chicago Homicide incidents from 2007-2009", 
          subtitle = "Murders separated by successful arrest or no arrest") +
  theme_void() +
